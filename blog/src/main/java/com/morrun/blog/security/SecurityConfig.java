package com.morrun.blog.security;
...
import com.morrun.blog.security.handler.AccessDeniedHandlerImpl;
import com.morrun.blog.security.handler.AuthenticationEntryPointImpl;
import com.morrun.blog.security.handler.AuthenticationFailureHandlerImpl;
import com.morrun.blog.security.handler.AuthenticationSuccessHandlerImpl;
import com.morrun.blog.security.handler.LogoutSuccessHandlerImpl;
...
//    	.and()
        http.csrf().disable()
        		.cors() // cors config.
        			.and()
            .authorizeRequests()
            	.antMatchers("/blogs/*","/comments/*").permitAll()
